...
public class _12ZigZagLinkedList
{
    ...
    // Rearrange list in zig-zag fashion using index toggling
    public static void zigZag(Node head)
    {
        ...
        while (curr != null && curr.next != null)
        {
            if (i % 2 == 0)
            {
                // even index: curr.data should be less than next.data
            ...
            {
                // odd index: curr.data should be greater than next.data
                if (curr.data < curr.next.data)
                {
                    int temp = curr.data;
                    curr.data = curr.next.data;
