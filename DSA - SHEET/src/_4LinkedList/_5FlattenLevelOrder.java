...
public class _5FlattenLevelOrder
{
    ...
    // Flatten multilevel linked list in level-order without using a queue
    public static Node flattenList(Node head)
    {
        ...
        // Step 2: Traverse list and append children at tail
        while (curr != null)
        {
            if (curr.child != null)
            {
                ...
                // Update tail to the last node of child list
